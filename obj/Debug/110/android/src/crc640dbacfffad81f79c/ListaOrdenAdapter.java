...
public class ListaOrdenAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("appOrdenTecnica.Adapter.ListaOrdenAdapter, appOrdenTecnica", ListaOrdenAdapter.class, __md_methods);
	}


	public ListaOrdenAdapter ()
	{
		super ();
		if (getClass () == ListaOrdenAdapter.class)
			mono.android.TypeManager.Activate ("appOrdenTecnica.Adapter.ListaOrdenAdapter, appOrdenTecnica", "", this, new java.lang.Object[] {  });
	}
