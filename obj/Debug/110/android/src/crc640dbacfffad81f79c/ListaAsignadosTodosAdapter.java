...
public class ListaAsignadosTodosAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("appOrdenTecnica.Adapter.ListaAsignadosTodosAdapter, appOrdenTecnica", ListaAsignadosTodosAdapter.class, __md_methods);
	}


	public ListaAsignadosTodosAdapter ()
	{
		super ();
		if (getClass () == ListaAsignadosTodosAdapter.class)
			mono.android.TypeManager.Activate ("appOrdenTecnica.Adapter.ListaAsignadosTodosAdapter, appOrdenTecnica", "", this, new java.lang.Object[] {  });
	}
