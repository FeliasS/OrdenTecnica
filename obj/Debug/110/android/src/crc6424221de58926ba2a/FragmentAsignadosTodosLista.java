...
public class FragmentAsignadosTodosLista
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("appOrdenTecnica.Fragments.FragmentAsignadosTodosLista, appOrdenTecnica", FragmentAsignadosTodosLista.class, __md_methods);
	}


	public FragmentAsignadosTodosLista ()
	{
		super ();
		if (getClass () == FragmentAsignadosTodosLista.class)
			mono.android.TypeManager.Activate ("appOrdenTecnica.Fragments.FragmentAsignadosTodosLista, appOrdenTecnica", "", this, new java.lang.Object[] {  });
	}


	public FragmentAsignadosTodosLista (int p0)
	{
		super (p0);
		if (getClass () == FragmentAsignadosTodosLista.class)
			mono.android.TypeManager.Activate ("appOrdenTecnica.Fragments.FragmentAsignadosTodosLista, appOrdenTecnica", "System.Int32, mscorlib", this, new java.lang.Object[] { p0 });
	}
