...
{
    public class FragmentEnProcesoxTecLista : AndroidX.Fragment.App.Fragment, ListaAsignadosTodosAdapter.OnItemListener, SearchView.IOnQueryTextListener
    {
        ...
        public override void OnCreate(Bundle savedInstanceState)
        {
            ...
            Activity.Title = "ORDENES QUE ESTOY RESOLVIENDO";
        }
        ...
        private async void LoadList()
        {
            ...
            if (response.StatusCode == System.Net.HttpStatusCode.OK) // System.Net.HttpStatusCode.OK
            {
                ...
                ordenes = resultado.lista.Where(x => x.ESTADO.StartsWith("3")).ToList(); ;
