...
{
    public class FragmentCulminadasxTecLista : AndroidX.Fragment.App.Fragment, ListaAsignadosTodosAdapter.OnItemListener, SearchView.IOnQueryTextListener
    {
        ...
        public override void OnCreate(Bundle savedInstanceState)
        {
            ...
            Activity.Title = "ORDENES ATENDIENDO";
        }
        ...
        private async void LoadList()
        {
            ...
            string empleado = pref.GetString(("idEmpleado"), ("idEmpleado"));
            ...
            if (response.StatusCode == System.Net.HttpStatusCode.OK) // System.Net.HttpStatusCode.OK
            {
                ...
                ordenes = resultado.lista.Where(x => x.ESTADO.StartsWith("4")).ToList(); ;
            ...
            /*BuscarPorEstyEmpOrdenTecnica log = new BuscarEstadoOrdenTecnica();
            log.estado = 5;

            HttpClient client = new HttpClient();
            Uri url = new Uri("http://micmaproyectos.com/orden/buscar..");
